...
To get started, read [How to set up Shockwaves](SETUP.md) and [How to get typed waveforms](START.md)
...
- [How to use the advanced translators](ADVANCED.md)
...
- [How to control VCD timings in multi-domain designs](MULTIDOM.md)
