...
managementUnit externalCounter maybeDna =
  -- 'withoutCircuitContext' once over the whole circuit discharges every
  -- component's 'HasCircuitContext' (synthesis-facing instance).
  withoutCircuitContext $ circuit $ \(mm, jtag) -> do
...
-- Synthesis-facing instance: 'withoutCircuitContext' once over the whole
-- circuit discharges every component's 'HasCircuitContext'.
