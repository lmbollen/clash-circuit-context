...
prop_ProgrammableMux = H.property $ do
  ...
  withByteOrder byteOrder $ do
    let
      ...
      dut =
        withClockResetEnable @System clockGen resetGen enableGen
          ...
          $ \wb -> do
            ...
            (Fwd rst, out) <- withoutCircuitContext (programmableMux counter) -< (wb, Fwd muLinks, Fwd peLinks)
      ...
      firstBCycleBv = pack $ packWordCI @8 firstBCycle
      armBv = pack $ packWordCI @8 True
